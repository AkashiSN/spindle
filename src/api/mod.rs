...
pub fn router(state: AppState) -> Router {
    let api = Router::new()
        ...
        .route("/cd/release-group/{id}/releases", get(cd::group_releases))
        ...
        .route("/jobs", get(jobs::list).delete(jobs::remove_many))
        .route("/jobs/{id}", axum::routing::delete(jobs::remove))
        ...
        .route("/inbox/summary", get(inbox::summary))
        ...
        .route("/inbox/{id}/discard", post(inbox::discard))
        .route("/inbox/{id}/undiscard", post(inbox::undiscard))
